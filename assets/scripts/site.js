...
!function (t, e) {
  ...
  var L = {
    ...
    for (var e, n = String(t), o = n.length, a = -1, r = "", i = n.charCodeAt(0); ++a < o;) {
      if (0 === (e = n.charCodeAt(a))) throw new InvalidCharacterError("Invalid character: the input contains U+0000.");
      1 <= e && e <= 31 || 127 == e || 0 === a && 48 <= e && e <= 57 || 1 === a && 48 <= e && e <= 57 && 45 === i ? r += "\\" + e.toString(16) + " " : r += 128 <= e || 45 === e || 95 === e || 48 <= e && e <= 57 || 65 <= e && e <= 90 || 97 <= e && e <= 122 ? n.charAt(a) : "\\" + n.charAt(a);
    }
  ...
  return function (o, t) {
      ...
      if (u || e) {
        ...
        var n,
          ...
          var n,
              ...
              a,
              r = C.pageYOffset;
          if (t == e || r == e || (l < e && C.innerHeight + r) >= S) return w.cancelScroll(!0), o = e, a = u, 0 === (n = i) && document.body.focus(), a || (n.focus(), document.activeElement !== n && (n.setAttribute("tabindex", "-1"), n.focus(), n.style.outline = "none"), C.scrollTo(0, o)), Q("scrollStop", c, i, s), !(A = d = null);
        },
            O = function O(t) {
          var e, n, o;
        ...
        0 === C.pageYOffset && C.scrollTo(0, 0), m = i, h = c, u || history.pushState && h.updateURL && history.pushState({
          ...
          anchor: m.id
        }, document.title, m === document.documentElement ? "#top" : "#" + m.id), Q("scrollStart", c, i, s), w.cancelScroll(!0), C.requestAnimationFrame(O);
      }
    };

    var e = function e(t) {
      if (!("matchMedia" in C && C.matchMedia("(prefers-reduced-motion)").matches) && 0 === t.button && !t.metaKey && !t.ctrlKey && "closest" in t.target && (a = t.target.closest(o)) && "a" === a.tagName.toLowerCase() && !t.target.closest(I.ignore) && a.hostname === C.location.hostname && a.pathname === C.location.pathname && /#/.test(a.href)) {
        var e = r(a.hash),
            n = I.topOnEmptyHash && "#" === e ? document.documentElement : document.querySelector(e);
        (n = n || "#top" !== e ? n : document.documentElement) && (t.preventDefault(), function (t) {
          if (history.replaceState && t.updateURL && !history.state) {
            var e = C.location.hash;
            e = e || "", history.replaceState({
              smoothScroll: JSON.stringify(t),
              anchor: e || C.pageYOffset
            }, document.title, e || C.location.href);
          }
        }(I), w.animateScroll(n, a));
      }
    },
        n = function n(t) {
      if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(I)) {
        var e = history.state.anchor;
        "string" == typeof e && e && !(e = document.querySelector(r(history.state.anchor))) || w.animateScroll(e, null, {
          updateURL: !1
        });
      }
    };
    ...
    return w.destroy = function () {
      I && (document.removeEventListener("click", e, !1), C.removeEventListener("popstate", n, !1), w.cancelScroll(), A = M = a = I = null);
    }, w.init = function (t) {
      ...
      w.destroy(), I = H(L, t || {}), M = I.header ? document.querySelector(I.header) : null, document.addEventListener("click", e, !1), I.updateURL && I.popstate && C.addEventListener("popstate", n, !1);
    }, w.init(t), w;
  };
});
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*! ScrollMagic v2.0.6 | (c) 2018 Jan Paepke (@janpaepke) | license & info: http://scrollmagic.io */
!function (e, i) {
  "function" == typeof define && define.amd ? define(["ScrollMagic", "jquery"], i) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? i(require("scrollmagic"), require("jquery")) : i(e.ScrollMagic, e.jQuery);
}(this, function (e, i) {
  "use strict";
...
.addTo(controller);
var announcementLineTop = new ScrollMagic.Scene({
  triggerHook: 0,
  triggerElement: "#intro",
  duration: "150%"
}).setTween("#announcement-line-top", 0.5, {
  x: '20%',
  ease: Linear.easeNone
}, {
  x: '-20%',
...
// .addIndicators({name: "intro (duration: 0)"}) // add indicators (requires plugin)
.addTo(controller);
var announcementLineBottom = new ScrollMagic.Scene({
  triggerHook: 0,
  triggerElement: "#announcement",
  duration: "150%"
}).setTween("#announcement-line-bottom", 0.5, {
  x: '-20%',
  ease: Linear.easeNone
}, {
  x: '20%',
...
.addTo(controller);
var projectsLine = new ScrollMagic.Scene({
  triggerHook: 0,
  triggerElement: "#contact",
  duration: "150%",
  offset: -600
}).setTween("#projects-line", 0.5, {
  x: '-20%',
  ease: Linear.easeNone
}, {
  x: '20%',
